...
import br.com.entra21.java.avancado.principal.aula1.enums.gameCharacter;
import br.com.entra21.java.avancado.principal.aula2.collections.AprenderCollection;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 3:
				AprenderCollection.aprender();// chamar classe dentro do main, classe deve ser static
				break;
